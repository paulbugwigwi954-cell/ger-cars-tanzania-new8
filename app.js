...
async function createListing(form){
 ...
 try{
   ...
   if(!files.length && !videoFile)throw new Error('Please upload at least one real car photo or one vehicle video.');
...
function openSell(){
 ...
 const updateMediaChoice=()=>{
   const photoLabel=photoInput.closest('.file-label'),videoLabel=videoInput.closest('.file-label');
